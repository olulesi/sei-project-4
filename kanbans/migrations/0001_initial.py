    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('background', models.PositiveIntegerField(choices=[(0, 'Default Background'), (1, 'Background 1'), (2, 'Background 2'), (3, 'Background 3'), (4, 'Background 4')], default=(0, 'Default Background'))),
